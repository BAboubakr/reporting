const COMPETITORS=['AFRY','Artelia','Tractebel','Mott MacDonald','WSP','Worley','Egis','ILF Consulting Engineers','DNV','NOVEC','INGEMA','JESA','RINA'];
const ALIASES={'AFRY':['afry'],Artelia:['artelia'],Tractebel:['tractebel','engie'],'Mott MacDonald':['mott macdonald','mott macdonald group'],'WSP':['wsp'],Worley:['worley'],Egis:['egis'],'ILF Consulting Engineers':['ilf consulting engineers','ilf'],'DNV':['dnv'],'NOVEC':['novec'],'INGEMA':['ingema'],'JESA':['jesa','jesa s.a','jesa sa'],'RINA':['rina','rina morocco','rina morocco sarl']};
