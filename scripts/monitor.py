...
NOISE=['nouvel utilisateur','créer un compte','se connecter','connexion','menu','accueil','contact','recherche','newsletter','mentions légales','politique de confidentialité','cookies','subscribe','sign in','log in','home','search']
...
def is_noise(text):
    t=normalize(text); return len(t)<18 or len(t)>350 or any(t==n or t.startswith(n+' ') for n in NOISE)
