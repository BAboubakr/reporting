...
def research_priority(signal):
    ...
    market_entry=hit(["opens office","opening office","new office","establishes office","establishes subsidiary","launches morocco","morocco subsidiary","morocco sarl","registered in casablanca","expands presence","market entry","local entity","local office"])
    competitor_move=competitor and hit(["contract","project","tender","appointed","selected","award","partnership","expands","wins","office","subsidiary","market entry","local entity"])
    ...
    if market_entry: score+=25; hard=max(hard,3); reasons.append("competitor market-entry signal")
    ...
    generic=not(tender or award or dfi or competitor or fichtner or major_project or financing or consulting or market_entry)
